const langData = {
  GR: {
    ...
    // --- Αρχική σελίδα ---
    heroTitle: "Καλωσήρθες στο μικρό μου δημιουργικό σύμπαν!",
    heroSubtitle: "Εδώ θα βρεις σκίτσα, fanarts, κόμικς, χαρακτήρες και κάθε τρελή ιδέα που με εμπνέει — από indie games μέχρι παιδικά καρτούν. Πάρε έναν καφέ, χαλάρωσε και ρίξε μια ματιά. Ελπίζω να σου αρέσει ό,τι δεις!",
    ...
    // --- Επικοινωνία ---
    contactTitle: "Γεια σου!",
    contactSubtitle: "Θες να συνεργαστούμε ή έχεις κάποια πρόταση;",
    contactHeading: "",
    contactText:
      "Στείλε μου μήνυμα — πάντα χαίρομαι να μιλάω με ανθρώπους που αγαπούν το σχέδιο." +
      " Ανυπομονώ να ακούσω την ιδέα σου!"+
      " Μπορείς να συμπληρώσεις την φόρμα ή να στείλεις e-mail απευθείας πατώντας εδώ: "+
